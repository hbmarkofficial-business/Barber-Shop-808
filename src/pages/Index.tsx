  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Augsburg | Barber Shop 808</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barber Shop 808 in Augsburg für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barber Shop 808 | Premium Barbershop Augsburg" />
        <meta
        ...
        <meta name="twitter:title" content="Barber Shop 808 | Premium Barbershop Augsburg" />
        <meta
